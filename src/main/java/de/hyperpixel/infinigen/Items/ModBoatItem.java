...
public class ModBoatItem extends Item {
    ...
    public ModBoatItem(boolean p_220013_, ModBoat.Type p_220014_, Item.Properties p_220015_) {
        super(p_220015_);
    ...
    private Boat getBoat(Level p_220017_, HitResult p_220018_) {
        return (Boat)(this.hasChest ? new ModChestBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z) : new ModBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z));
    }
